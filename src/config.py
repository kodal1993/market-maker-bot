...
BOT_GIT_COMMIT = _env_str("BOT_GIT_COMMIT", "unknown").strip() or "unknown"
...
RESET_PAPER_STATE_ON_START = _env_bool("RESET_PAPER_STATE_ON_START", False)
...
# V7 adaptive strategy flags.
ENABLE_TREND_MODE = _env_bool("ENABLE_TREND_MODE", True)
ENABLE_MARKET_MAKING = _env_bool("ENABLE_MARKET_MAKING", True)
ENABLE_BREAKOUT_MODE = _env_bool("ENABLE_BREAKOUT_MODE", True)
ENABLE_LEVERAGE = _env_bool("ENABLE_LEVERAGE", False)
...
RECOVERY_MAX_TRADE_USD = max(_env_float("RECOVERY_MAX_TRADE_USD", 7.5), 0.0)
RECOVERY_CONFLICT_SIZE_MULTIPLIER = _clamp(_env_float("RECOVERY_CONFLICT_SIZE_MULTIPLIER", 0.30), 0.10, 0.50)
...
ACTIVITY_ALIGNMENT_BOOST_ENABLED = _env_bool("ACTIVITY_ALIGNMENT_BOOST_ENABLED", True)
ACTIVITY_ALIGNMENT_MIN_EDGE_SCORE = _env_float("ACTIVITY_ALIGNMENT_MIN_EDGE_SCORE", 72.0)
ACTIVITY_ALIGNMENT_MIN_FEED_SCORE = _env_float("ACTIVITY_ALIGNMENT_MIN_FEED_SCORE", 0.12)
ACTIVITY_ALIGNMENT_MAX_RISK_SCORE = _env_float("ACTIVITY_ALIGNMENT_MAX_RISK_SCORE", 0.56)
ACTIVITY_ALIGNMENT_MIN_ONCHAIN_SCORE = _env_float("ACTIVITY_ALIGNMENT_MIN_ONCHAIN_SCORE", -0.20)
ACTIVITY_ALIGNMENT_BOOST_SIZE_MULTIPLIER = _env_float("ACTIVITY_ALIGNMENT_BOOST_SIZE_MULTIPLIER", 1.08)
ACTIVITY_ALIGNMENT_BOOST_SPREAD_MULTIPLIER = _env_float("ACTIVITY_ALIGNMENT_BOOST_SPREAD_MULTIPLIER", 0.96)
