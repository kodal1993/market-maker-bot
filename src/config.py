...
PROFILE_VERSION = _env_str("PROFILE_VERSION", "v7.1")
GIT_COMMIT = _env_str("GIT_COMMIT", "")
RECOVERY_REENTRY_MINUTES = max(_env_float("RECOVERY_REENTRY_MINUTES", 60.0), 0.0)
RECOVERY_REENTRY_DRIFT_PCT = max(_env_float("RECOVERY_REENTRY_DRIFT_PCT", 25.0), 0.0)
MAX_RECOVERY_TRADE_USD = max(_env_float("MAX_RECOVERY_TRADE_USD", 10.0), 0.0)
RECOVERY_UPPER_TF_CONFLICT_SIZE_MULTIPLIER = _clamp(
    _env_float("RECOVERY_UPPER_TF_CONFLICT_SIZE_MULTIPLIER", 0.30),
    0.25,
    0.35,
)
